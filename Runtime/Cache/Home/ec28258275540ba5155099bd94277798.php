...
<html lang="en"><head>
  ...
  <div class="article-list-bd">
    <div class="bd-wrapper">
      <div class="bd-hd">
        <div class="bd-container">
          ...
          <?php if(is_array($tptg)): $i = 0; $__LIST__ = $tptg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
              <div class="menu-info">
              ...
              <?php if($vo[pic] != ''): ?><img src="/<?php echo ($vo["pic"]); ?>" alt="<?php echo ($vo["title"]); ?>">
                ...
                <div class="info-inner">
                  <h3><span>[ 标签：<a href="#"><?php echo ($vo["view"]); ?></a> ]</span><?php echo ($vo["title"]); ?></h3>
                  <div class="inner-brief">
                   <?php echo ($vo["description"]); ?>...
                  </div>
                  
                  <a href="<?php echo u('Index/article1',array('id'=>$vo[id]));?>">
    ...
    <a title="<?php echo ($vo["title"]); ?>" href="<?php echo U('Home/Index/article1',array('id'=>$vo['id']));?>"><?php endif; echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            </div>
          </div>
